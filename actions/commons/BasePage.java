...
public class BasePage {
	...
	protected void getElementAttribute(WebDriver driver, String locatorType, String attributeName) {
		getWebElement(driver, locatorType).getAttribute(attributeName);
	}
