...
public class BasePage {
	...
	protected void getElementAttribute(WebDriver driver, String xpathLocator, String attributeName) {
		getWebElement(driver, xpathLocator).getAttribute(attributeName);
	}
