...
public class AdminPostSearchPageUI {
	...
	public static final String ROW_CHECKBOX_BY_TITLE_NAME = "xpath=//table[contains(@class,'table-view-list posts')]//tbody//tr//span[contains(text(),'%s')]/parent::label/following-sibling::input";
	...
	public static final String NO_POST_FOUND_MESSAGE = "xpath=//table[contains(@class,'table-view-list posts')]//tbody/tr[@class='no-items']/td[text()='%s']";
}
