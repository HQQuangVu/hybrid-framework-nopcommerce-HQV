...
public class Level_02_Apply_BasePage_III extends BasePage {
	...
	public void TC_02_Invalid_Email() {
		...
		sendkeyToElement(driver, "//input[@id='LastName']", "HQ");
		sendkeyToElement(driver, "//input[@id='Email']", "dsjf$djsfhjkd@&^");
	...
	public void TC_04_Existing_Email() {
		...
		Assert.assertEquals(getElementText(driver, "//div[contains(@class,'validation-summary-errors')]//li"), "The specified email already exists");
